...
<body style="
        ...
        ">
    <div style="display: none">Welcome {{ $user->full_name }}</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24" style="
                                            ...
                                            <p style="margin: 24px 0">
                                                Your verification code is: <b>{{ $token }}</b>. This code is valid for 10 minutes. Please enter this code on the verification page to complete the registration process. If you didn't request this code, please ignore this message. Thank you.
                                            </p>
                                            <table style="
                                                        font-family: 'Montserrat',
                                                            Arial, sans-serif;
